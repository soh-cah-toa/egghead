...
# Test + "increment" command
{
    ...
    my $pid = open3(undef,
                    \*EH_STDOUT,
                    undef,
                    "$egghead tests/testlib/increment.bf");
    ...
    is($got, $expected, 'Testing + "increment" command');
}
...
# Test - "decrement" command
{
    ...
    my $pid = open3(undef,
                    \*EH_STDOUT,
                    undef,
                    "$egghead tests/testlib/decrement.bf");
    ...
    is($got, $expected, 'Testing - "decrement" command');
}
...
# Test [ and ] "loop" commands
{
    ...
    is($got, $expected, 'Testing [ and ] "loop" commands');
}
